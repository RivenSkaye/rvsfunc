...
def dehalo_mask(clip: vs.VideoNode, maskgen: Callable[[vs.VideoNode, Any], vs.VideoNode] = ..., iter_out: int = ..., iter_in: int = ..., inner: bool = ..., outer: bool = ..., **mask_args) -> vs.VideoNode: ...
def fineline_mask(clip: vs.VideoNode, thresh: int = ...): ...
